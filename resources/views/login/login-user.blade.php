...
<html lang="en">
  ...
  <p class="fs-5 text-dark md-5 text-center fw-bolder"> Tidak memiliki akun ? <a href=login.blade.php>Daftar sekarang</a></p>

  <div class="button text-center pe-5">
  <a href=login.blade.php><button type="button"  class="btn btn-primary "> MASUK </button></a>
  </div>
</form>
      </div>
    </div>
