  ...
  <div class="container">
    <div class="global-container">
      <div class="card login-form shadow  p-auto m-3">
        <form>
          <h1 class="card-title my-1 fs-3 fw-bold py-3">Foto Produk / Usaha</h1>
          <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label mb-5">Upload foto Produk / Usaha anda sebagai berikut :</label>
            <img src="img/ktp.png" alt="ktp">
            <p class="text-dark fs-5 fw-bolder mt-3">Perhatikan hal-hal berikut :</p>
