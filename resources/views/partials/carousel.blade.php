<header class="header home p-5" id="beranda">
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
    ...
    <div class="carousel-inner">
      <div
        style="background-image: url(https://gmedia.net.id/upload/foto_artikel/20210705FkVktopple.jpg); height: 500px; width: 1250px; border-radius: 10px; padding:100px">
        <div class="container">
          <div class="card" style="width: 26rem; height: 18rem; ">
            <div class="card-body">
              <div class="slider text-primary">
                ...
                <div class="card-body">
                  <h5 class="card-title">Cara Mengguunakan Google Meet</h5>
                  <div class="home-greetings__buttons mt-3">
                    <div class="row" id="dates">
                      ...
                      <a id="btn" class="nav-link" href="detail_event"><button type="button"
                          class="btn btn-outline-primary">Daftar Event</button></a>
                    </div>
                  </div>
                </div>
              </div>
