...
<head>
    ...
    <title>Diskopindag Malang</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-light sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3" style="color:#2552AA;">Diskopindag Malang</div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" style="color:#2552AA;" href="index.html">
                    <i style="color:#2552AA;" class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Dashboard</span></a>
            </li>

            <li class="nav-item active">
                <a class="nav-link" style="color:#2552AA;" href="index.html">
                    <i style="color:#2552AA;" class="fas fa-calendar text-primary-300"></i>
                    <span>Event</span></a>
            </li>

            <li class="nav-item active">
                <a class="nav-link"  style="color:#2552AA;" href="index.html">
                    <i class="fas fa-clipboard-list" style="color:#2552AA;"></i>
                    <span>Manajemen Akun</span></a>
            </li>

            <li class="nav-item active">
                <a class="nav-link" style="color:#2552AA;" href="index.html">
                    <i style="color:#2552AA;" class="fas fa-user"></i>
                    <span>Profil</span></a>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Peserta Hadir
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Peserta Event</h6>
                    ...
                    <div class="row">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-dark">Status Peserta</h6>
                                </div>
                                <div class="card-body">
    ...
    <script src="css/demo/chart-area-demo.js"></script>
    <script src="css/demo/chart-pie-demo.js"></script>
    <script src="css/demo/chart-bar-demo.js"></script>
